...
public protocol LogHandler: _SwiftLogSendableLogHandler {
    ...
    func log(level: LoggingExt.Logger.Level, message: LoggingExt.Logger.Message, metadata: LoggingExt.Logger.Metadata?, file: String, function: String, line: UInt)
...
extension LogHandler {
    ...
    @available(*, deprecated, renamed: "log(level:message:metadata:source:file:function:line:)")
    public func log(level: LoggingExt.Logger.Level, message: LoggingExt.Logger.Message, metadata: LoggingExt.Logger.Metadata?, file: String, function: String, line: UInt) {
